...
function makeCandidate(
  ...
  return {
    ...
    classification: {
      ...
      embedding: [0.45, 0.0, 0.16, 0.12, 0.04, 0.0, 0.0],
  ...
  await addEntry(
    makeCandidate({
      ...
      classification: {
        ...
        material: null,
        tags: ["monster", "organic"],
        embedding: [0.45, 0.65, 0.16, 0.12, 0.04, 0.0, 0.02],
        analysisRef: "creature_seed-00042.json",
      },
    }),
    dummyWav(),
  ...
  await addEntry(
    makeCandidate({
      ...
      classification: {
        ...
        material: "metal",
        tags: ["hit", "impact"],
        embedding: [0.70, 0.95, 0.08, 0.55, 0.027, 0.10, 0.01],
  ...
  await addEntry(
    makeCandidate({
      ...
      classification: {
        ...
        material: null,
        tags: ["snake", "organic"],
        embedding: [0.30, 0.40, 0.20, 0.15, 0.067, 0.0, 0.05],
